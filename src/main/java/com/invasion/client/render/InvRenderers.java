...
import com.invasion.client.render.entity.RenderBurrower;
...
import com.invasion.client.render.entity.RenderTnt;
...
public interface InvRenderers {
    static void bootstrap() {
        ...
        EntityRendererRegistry.register(InvEntities.BURROWER, RenderBurrower::new);
        EntityRendererRegistry.register(InvEntities.BOULDER, RenderBoulder::new);
        EntityRendererRegistry.register(InvEntities.TNT, RenderTnt::new);
