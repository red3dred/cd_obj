...
public class TileEntityNexus extends BlockEntity implements SidedInventory, NamedScreenHandlerFactory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new ContainerNexus(syncId, playerInventory, this, nexus.getProperties(), ScreenHandlerContext.create(player.getWorld(), getPos()));
    }
