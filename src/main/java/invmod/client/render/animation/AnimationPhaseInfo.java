...
public record AnimationPhaseInfo (
    ...
    public AnimationPhaseInfo(AnimationAction action, float timeBegin, float timeEnd, Map<AnimationAction, Transition> transitions) {
    ...
    public static class Builder {
        ...
        public AnimationPhaseInfo build() {
            return new AnimationPhaseInfo(action, timeBegin, timeEnd, defaultTransition, Map.copyOf(transitions));
        }
    }
}