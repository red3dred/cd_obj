...
public class IMWaveBuilder {
    ...
    private static final IEntityIMPattern DEFAULT_PATTERN = new EntityPattern(IMEntityType.ZOMBIE).addTier(1, 1.0F).addFlavour(0, 3.0F).addFlavour(1, 1.0F);
    ...
    private RandomSelectionPool<IEntityIMPattern> generateGroupPool(float tierLevel, RandomSelectionPool<IEntityIMPattern> startPool, float weight) {
        ...
        return startPool.addEntry(new RandomSelectionPool<IEntityIMPattern>()
            ...
            .addEntry(new RandomSelectionPool<IEntityIMPattern>()
                .addEntry(getPattern("pigengy_t1_any"), 4.0F)
        ...
        case 2:
            ...
            return new Wave(120000, 15000, List.of(
                    ...
                    new WaveEntry(20000, 23000, 1, 500, new RandomSelectionPool<IEntityIMPattern>()
                            .addEntry(getPattern("pigengy_t1_any"), 1.0F)),
        ...
        case 3:
            ...
            return new Wave(120000, 18000, List.of(
                    ...
                    new WaveEntry(10000, 12000, 1, 500, new RandomSelectionPool<IEntityIMPattern>()
                            .addEntry(getPattern("spider_t2_any"), 1.0F)),
    ...
    private static Wave generateExtendedWave(int waveNumber) {
        ...
        return new Wave((int) (timeScale * 120000.0F), (int) (timeScale * 35000.0F), List.of(
                new WaveEntry(0, (int) (timeScale * 30000.0F), (int) (mobScale * 7.0F), 2000, new RandomSelectionPool<IEntityIMPattern>()
                ...
                new WaveEntry(0, (int) (timeScale * 90000.0F), (int) (mobScale * 3.0F), 500, new FiniteSelectionPool<IEntityIMPattern>()
                        .addEntry(getPattern("spider_t2_any"), 2)
                        .addEntry(getPattern("pigengy_t1_any"), 1)),
                new WaveEntry((int) (timeScale * 65000.0F), (int) (timeScale * 67000.0F), (int) (mobScale * 7.0F), 500, new RandomSelectionPool<IEntityIMPattern>()
                        ...
                        .addEntry(getPattern("spider_t2_any"), 1.0F)
                        .addEntry(getPattern("zombie_t1_any"), 1.0F)
                        .addEntry(getPattern("skeleton_t1_any"), 1.0F)
                ...
                new WaveEntry((int) (timeScale * 95000.0F), (int) (timeScale * 97000.0F),
                        (int) (mobScale * 6.0F), 500, new FiniteSelectionPool<IEntityIMPattern>()
